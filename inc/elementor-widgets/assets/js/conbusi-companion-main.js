(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".conbusi-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".conbusi-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".conbusi-team-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.conbusi-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.conbusi-portfolio').isotope({
    ...
    // MC Scripts
    var $subscribe = $( '.conbusi-subscribe-newsletter-area' );
    if( $subscribe.length ){
