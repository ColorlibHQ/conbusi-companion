...
/**
 *
 * Conbusi elementor app section widget.
 *
 * @since 1.0
 */
class Conbusi_App_Section extends Widget_Base {

	public function get_name() {
		return 'conbusi-app-section';
	}

	public function get_title() {
		return __( 'App Section', 'conbusi-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'apps_content',
            [
                'label' => __( 'App Section Settings', 'conbusi-companion' ),
            ]
        );
        $this->add_control(
            'sec_img',
            [
                ...
                'description' => esc_html__( 'Best size is 1920x456', 'conbusi-companion' ),
        ...
        $this->add_control(
            'ios_url',
            [
                'label' => esc_html__( 'IOS App URL', 'conbusi-companion' ),
        ...
        $this->add_control(
            'android_url',
            [
                'label' => esc_html__( 'Android App URL', 'conbusi-companion' ),
                'type' => Controls_Manager::URL,
                'label_block' => true,
                'default'   => [
                    'url' => '#'
    ...
    public function conbusi_left_contents( $sec_title, $sec_text, $btn_label, $btn_url, $style_type ) {
    ...
    public function conbusi_right_contents( $sec_img, $style_type ) {
    ...
    $ios_app_path = CONBUSI_DIR_ICON_IMG_URI . 'ios-app.svg';
    $android_app_path = CONBUSI_DIR_ICON_IMG_URI . 'android-app.svg';
    ?>
    
    <!-- productivity_area  -->
    <div class="productivity_area" <?php echo conbusi_inline_bg_img( esc_url( $sec_img ) ); ?>>
        <div class="container">
