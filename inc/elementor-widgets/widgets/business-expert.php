...
/**
 *
 * Conbusi elementor business expert section widget.
 *
 * @since 1.0
 */
class Conbusi_Business_Expert extends Widget_Base {

	public function get_name() {
		return 'conbusi-business-expert';
	}

	public function get_title() {
		return __( 'Business Expert', 'conbusi-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Business Expert content', 'conbusi-companion' ),
			]
        );
		$this->add_control(
            'tab_content', [
                ...
                'fields' => [
                    [
                        'name' => 'tab_title',
                        'label' => __( 'Tab Title', 'conbusi-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Excellent Services', 'conbusi-companion' ),
                    ],
                    [
                        'name' => 'template_id',
                        'label' => __( 'Select Elementor Template', 'conbusi-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [      
                        'tab_title' => __( 'Excellent Services', 'conbusi-companion' ),
                    ],
                    [      
                        'tab_title' => __( 'Qualified Doctors', 'conbusi-companion' ),
                    ],
                    [      
                        'tab_title' => __( 'Emergency Departments', 'conbusi-companion' ),
                    ],
                ]
            ]
		);
    ...
    $this->start_controls_section(
        'style_room_section', [
            'label' => __( 'Style Business Expert Section', 'conbusi-companion' ),
            'tab' => Controls_Manager::TAB_STYLE,
        ]
    );
    $this->add_control(
        'section_head_bg_col', [
            'label' => __( 'Section Head Bg Color', 'conbusi-companion' ),
    ...
    $this->add_control(
        'tab_content_styles_separator', [
            'label' => __( 'Tab Content Styles', 'conbusi-companion' ),
    ...
    $this->add_control(
        'icon_bg_col', [
            'label' => __( 'Icon Bg Color', 'conbusi-companion' ),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
