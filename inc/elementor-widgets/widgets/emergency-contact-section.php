...
/**
 *
 * Conbusi elementor emergency-contact section section widget.
 *
 * @since 1.0
 */
class Conbusi_Emergency_Contact_Section extends Widget_Base {

	public function get_name() {
		return 'conbusi-emergency-contact-section';
	}

	public function get_title() {
		return __( 'Emergency Contact Section', 'conbusi-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Emergency Contact Section', 'conbusi-companion' ),
            ]
        );
        $this->add_control(
            'emergency_contact_settings_seperator',
            [
                'label' => esc_html__( 'Emergency Contact Section', 'conbusi-companion' ),
        ...
        $this->add_control(
            'ec_bg_img',
            [
                'label' => esc_html__( 'BG Image', 'conbusi-companion' ),
        ...
        $this->add_control(
            'ec_title',
            [
                'label' => esc_html__( 'Title', 'conbusi-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( 'For Any Emergency Contact', 'conbusi-companion' ),
            ]
        );
        $this->add_control(
            'ec_text',
            [
                'label' => esc_html__( 'Text', 'conbusi-companion' ),
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
                'default' => esc_html__( 'Esteem spirit temper too say adieus.', 'conbusi-companion' ),
            ]
        );
        $this->add_control(
            'ec_btn_label',
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( '+10 378 4673 467', 'conbusi-companion' ),
            ]
        );
        $this->add_control(
            'ec_btn_url',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Online Appointment Section', 'conbusi-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( 'Make an Online Appointment', 'conbusi-companion' ),
            ]
        );
        $this->add_control(
            'oa_text',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( 'Make an Appointment', 'conbusi-companion' ),
            ]
        );
        $this->add_control(
            'oa_btn_url',
        ...
        $this->start_controls_section(
            'left_sec_style', [
                'label' => __( 'Top Section Styles', 'conbusi-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Overlay Color Styles', 'conbusi-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
			'sec_title_col', [
				'label' => __( 'Bg Overlay Color', 'conbusi-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
    ...
    <div class="Emergency_contact">
        <div class="conatiner-fluid p-0">
            <div class="row no-gutters">
                <div class="col-xl-6">
                    <div class="single_emergency d-flex align-items-center justify-content-center overlay_skyblue" <?php echo conbusi_inline_bg_img( esc_url( $ec_bg_img ) ); ?>>
                        <div class="info">
                            <?php 
                                if ( $ec_title ) { 
                ...
                <div class="col-xl-6">
                    <div class="single_emergency d-flex align-items-center justify-content-center overlay_skyblue" <?php echo conbusi_inline_bg_img( esc_url( $oa_bg_img ) ); ?>>
                        <div class="info">
                            <?php 
                                if ( $oa_title ) { 
