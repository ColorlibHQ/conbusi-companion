...
/**
 *
 * Conbusi Review Contents section widget.
 *
 * @since 1.0
 */
class Conbusi_Review_Contents extends Widget_Base {

	public function get_name() {
		return 'conbusi-review-contents';
	}

	public function get_title() {
		return __( 'Review Contents', 'conbusi-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'reviews_content',
			[
				'label' => __( 'Review Contents', 'conbusi-companion' ),
			]
        );
		...
		$this->add_control(
            'reviews', [
                ...
                'fields' => [
                    ...
                    [
                        'name' => 'review_txt',
                        'label' => __( 'Review Text', 'conbusi-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'review_stars',
                        'label' => __( 'Review Stars', 'conbusi-companion' ),
                    ...
                    [
                        'name' => 'reviewer_name',
                        'label' => __( 'Client Name', 'conbusi-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( '- Robert Smile', 'conbusi-companion' ),
                    ],
                ],
                'default'   => [
                    [
                        ...
                        'review_stars'         => '5',
                        'reviewer_name'         => __( '- Robert Smile', 'conbusi-companion' ),
                    ],
                    [
                        'sec_title'            => 'Review from our <br> regular users',
                        'review_txt'            => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod <br> tempor incididunt labore et dolore magna aliqua <br> quis ipsum suspendisse ultrices.',
                        'review_stars'         => '5',
                        'reviewer_name'         => __( '- John Doe', 'conbusi-companion' ),
                    ],
                    [
                        'sec_title'            => 'Review from our <br> regular users',
                        'review_txt'            => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod <br> tempor incididunt labore et dolore magna aliqua <br> quis ipsum suspendisse ultrices.',
                        'review_stars'         => '5',
                        'reviewer_name'         => __( '- Jonathan Doe', 'conbusi-companion' ),
                    ],
                ]
            ]
        );
        ...
        $this->start_controls_section(
            'style_title', [
                'label' => __( 'Style Review Section', 'conbusi-companion' ),
        ...
        $this->add_control(
            'sec_overlay_col', [
                'label' => __( 'Section Overlay Color', 'conbusi-companion' ),
    ...
    <!-- testmonial_area  -->
    <div class="testmonial_area" <?php echo conbusi_inline_bg_img( esc_url( $sec_bg ) ); ?>>
        <div class="container">
            <div class="col-xl-12">
                <div class="testmonial_active owl-carousel">
                    ...
                    if( is_array( $reviews ) && count( $reviews ) > 0 ){
                        foreach ( $reviews as $review ) {
                            ...
                            $client_img = !empty( $review['client_img']['id'] ) ? wp_get_attachment_image( $review['client_img']['id'], 'conbusi_testimonial_author_thumb_35x35', '', array( 'alt' => $reviewer_name. ' image' ) ) : '';
                            ?>
