...
----------------------------------------*/
class conbusi_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('conbusi_instagram_photo',esc_html__('[ Conbusi ] Intagram Photo','conbusi-companion'),array(
			'description' => esc_html__('Conbusi Instagram Photo Widget','conbusi-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'conbusi-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'conbusi-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'conbusi-companion'); ?></label>
...
if(!function_exists('conbusi_instagram_widgets')):
	function conbusi_instagram_widgets(){
		register_widget('conbusi_instagram_photo');
	}
	add_action('widgets_init','conbusi_instagram_widgets');
endif;
