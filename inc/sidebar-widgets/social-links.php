...
class Conbusi_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'conbusi_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Conbusi ] Social Links', 'conbusi-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'conbusi-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'conbusi-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'conbusi-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'conbusi-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'conbusi-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'conbusi-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'conbusi-companion'); ?></label>
...
} // Class conbusi_social_links ends here


// Register and load the widget
function conbusi_social_links_widget_load() {
	register_widget( 'Conbusi_social_links' );
}
add_action( 'widgets_init', 'conbusi_social_links_widget_load' );